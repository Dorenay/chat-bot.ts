...
var scenario = {
    ...
    step: function (step, error) {
        var args = [];
        for (var _i = 2; _i < arguments.length; _i++) {
            args[_i - 2] = arguments[_i];
        }
        var msg; // переменная, которая будет хранить стринг первого сообщения бота
        ...
        bot.createForm.apply(//вывод первой строки блока сообщений бота
        bot, args); //вывод формы для заполнения данных юзером
    },
    //подготовка шага. answer - id поля с ответом на последнее сообщение 
    nextStep: function (answer) {
        if (answer === void 0) { answer = undefined; }
        if (answer != undefined) {
...
var bot = {
    ...
    createRequest: function (msg, target) {
...
function messages_prepare(msg) {
    function set_values(text) {
        ...
        for (var depandence in dependencies) {
...
},{"./message":3,"jquery":1}],3:[function(require,module,exports){
"use strict";
var messages = {
    name: {
